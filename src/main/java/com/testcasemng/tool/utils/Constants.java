...
public interface Constants {
    ...
    String SHARP_PASS = "PASSED";
    String SHARP_FAIL = "FAILED";
    String SHARP_NOT_EXECUTED = "NOT YET RUN";

    String SHARP_REPO_PREFIX = "https://github.com/logigear-japan/sh_r_test/tree/T1-S/auto/src/test/java/tests/";
    String SHARP_GAME_SETTING = "GamingSettings";
    String SHARP_AUTO_ZOOM = "AutoZoom";
    String SHARP_REGRESSION = "Regression test";
    String SHARP_DEVICE_NAME = "d41-A"; // "d41-A"; //"AQUOS sense4 plus";
    String SHARP_DEVICE_MODEL = "XD16"; // "XD16"; // XH76
